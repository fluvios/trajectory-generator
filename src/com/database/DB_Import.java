...
import com.ifc.dataextraction.ExtractFloors;
import com.ifc.dataextraction.ExtractPartitions;
import com.ifc.dataextraction.ExtractStairs;
import com.ifc.dataextraction.IfcFileParser;
import com.ifc.dataextraction.spatialobject.Building;
import com.ifc.dataextraction.spatialobject.Door;
import com.ifc.dataextraction.spatialobject.Elevator;
import com.ifc.dataextraction.spatialobject.Partition;
import com.ifc.dataextraction.spatialobject.Stair;
import com.ifc.datamanipulation.Decomposition;
import com.ifc.datamanipulation.Grid;
import com.ifc.datamanipulation.Mapping;
...
public class DB_Import {
	...
	public static void importAll(Connection con, Integer fileID, File file) throws SQLException {
		...
		ArrayList<com.ifc.dataextraction.spatialobject.Floor> floors = importFloors(con);
	 ...
	 * Import floors
	 */
	private static ArrayList<com.ifc.dataextraction.spatialobject.Floor> importFloors(Connection con)
			throws SQLException {

		ArrayList<com.ifc.dataextraction.spatialobject.Floor> floors = ExtractFloors
				.GetAllFloorObjects();

		for (int i = 0; i < floors.size(); i++) {
			com.ifc.dataextraction.spatialobject.Floor f = floors.get(i);
	...
	public static void mapD2P(Connection con) throws SQLException {
		...
		for (AccessPoint ap : DB_WrapperLoad.accesspointT) {
			if (ap.getApType().equals(0)) {
				ArrayList<com.database.spatialobject.Partition> connParts = Mapping.MapD2P(con, ap);
				for (com.database.spatialobject.Partition part : connParts) {
	...
	public static void importStairs(Connection con,
			ArrayList<com.ifc.dataextraction.spatialobject.Floor> floors,
